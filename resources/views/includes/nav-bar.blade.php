<nav class="navbar navbar-expand-lg navbar-white fixed-top" id="banner">
    <div class="container">
        <!-- Brand -->
        <a class="navbar-brand" href="/"><span><img src="{{ isset($navbar->logo) ? asset('storage/' . $navbar->logo) : 'img/core-img/logopng.png'}}"  style="width: 120px; height: 50px; " alt="logo"></span> </a>
...
{{--                </li>--}}
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('home-page.index_1') }}">{{ $navbar->home ?? '' }}</a>
                </li>
                <li class="nav-item">
