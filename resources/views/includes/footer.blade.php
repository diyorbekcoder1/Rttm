            ...
            <div class="col-12 col-lg-4 col-md-6">
                <div class="footer-copywrite-info">
                    ...
                    <div class="copywrite_text fadeInUp" data-wow-delay="0.2s">
                        <div class="footer-logo"><a href="#"><img src="{{ isset($navbar->logo) ? asset('storage/' . $navbar->logo) : 'img/core-img/logopng.png'}}"  style="width: 120px; height: 50px; " alt="logo">  </a></div>
